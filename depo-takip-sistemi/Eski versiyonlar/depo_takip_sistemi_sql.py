"""
Python Version: 3.12
File: depo_takip_sistemi_sql.py
Created Date: 2024-03-27
Author: Cemil İlkim Teke
Pylint Score: 8.36/10
"""
# Dosya Yolu ve Çalışma Dizinini almak için gerekli kütüphaneler
import os
import sys
...
# Veri tabanı kullanmak için gereken py dosyası ve kütüphane
...
{Fore.CYAN}5{Fore.RESET} - Kullanıcı Listesi
...
\n"""))
            if ilk_secim == 1:
                ...
                print(f"{Fore.LIGHTRED_EX}\nLütfen Geçerli Bir Sayı Giriniz! (1-5)\n")
                playsound(f"{cwd}//assests//error_sound.wav", block=False)
    except ValueError:
